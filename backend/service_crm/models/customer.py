...
class Customer(Base):
    ...
    tags = Column(JSON, nullable=True, default=list)  # Customer tags/labels (e.g., ['VIP', 'Regular', 'New'])
    last_visit = Column(TIMESTAMP(timezone=True), nullable=True)  # Last visit/order timestamp
